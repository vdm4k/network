...
bool stream::get_local_address(proto::ip::address::version ver, int fd,
...
bool stream::fill_sockaddr(const proto::ip::full_address &ipaddr,
                           sockaddr_in &addr) {
...
bool stream::bind_on_address(proto::ip::full_address const &self_address) {
